...
document.addEventListener("click", function (event) {
  ...
  if (
    event.target.classList.contains("item-inner") &&
  ...
  if (
    event.target.parentElement.classList.contains("item-inner") &&
...
function moveImage(event, direction) {
  ...
  activeImages.style.transform =
    "translateX(" + translateImageByThisAmount + "px)";
}
